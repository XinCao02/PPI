...
class ProteinDataset(Dataset):
    ...
    def process(self):
        ...
        self.data = self.processed_paths        ### 未用到
...
# ============================================================================================================================================
               ...
               node_feats = self._get_1024_seqvec(seq)
          ...
          #edge-index extracted
               ...
               edge_index = None  # Initialize edge_index to avoid referencing before assignment
          ...
          # create data object
                 ...
                 print(f'For count={count}\tgreater ct={greaterct}')
        ...
        #    try:              
           if edge_index is not None:
              pbar.set_postfix(num_edges = len(edge_index[1]), Node_ftsz = node_feats.shape[0], mat_sz = mat.shape[0],)
        #    except:
        #          print("ERROR OCCURRED! SKIPPING PROT:",file)
    ...
    def _get_1024_seqvec(self, sequence):
...
root = "/home/PPI_test1/Other_Datasets/YEAST"

prot_graphs = ProteinDataset(root)
